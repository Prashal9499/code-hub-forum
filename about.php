...
<body>
  ...
  <div class="container my-4">
    <div class="jumbotron">
      ...
      <p class="lead">
        CodeZilla is founded in 2021 by developers, for developers. It is now a valuable resource for people who
      ...
      <p class="lead">
        Our solution providers hail from all over the spectrum of Programming world, from geeks and professionals (some
        even
        interchangeably) to hobbyists, and are devoted to providing you with the best possible solutions of programming,
        coding and community discussion. If you would like to join our Staff, let us know!</p>
